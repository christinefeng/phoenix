...
public class PowerFunctionTest {
    private static final Expression ONE_POINT_FIVE = new LiteralExpression.Builder().setValue(1.5).buildValueAndDeterminism(false);
    private static final Expression TWO = new LiteralExpression.Builder().setValue(2).buildValueAndDeterminism(false);
    private static final Expression THREE = new LiteralExpression.Builder().setValue(3).buildValueAndDeterminism(false);
