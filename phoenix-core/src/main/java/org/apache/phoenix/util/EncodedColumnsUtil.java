...
public class EncodedColumnsUtil {
    ...
    public static Expression[] createColumnExpressionArray(int maxEncodedColumnQualifier) {
        ...
        Arrays.fill(colValues, new DelegateExpression(new LiteralExpression.Builder().buildValueAndDeterminism(false)) {
        ...
        colValues[0]= new LiteralExpression.Builder().setValue(QueryConstants.EMPTY_COLUMN_VALUE_BYTES).buildValueAndDeterminism(false);
        return colValues;
    }
